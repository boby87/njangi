...
CREATE TABLE notifications.notification (
    ...
    -- Clé Java : destinatreId (simplifié) — colonne SQL : destinataire_id (français correct)
...
COMMENT ON TABLE  notifications.notification               IS 'Notifications envoyées aux membres Njangi';
...
COMMENT ON COLUMN notifications.notification.destinataire_id IS 'UUID du membre destinataire (champ Java : destinatreId)';
